...
public class DecimalTests {
    ...
    private static PositiveDecimal OneHundred => PositiveDecimal.Create(DecimalHundred).Data;
    private static PositiveDecimal Two => PositiveDecimal.Create(DecimalTwo).Data;
    ...
    public void PositiveDecimal_Times_Correctly_Multiplies() {
        Result<PositiveDecimal> multiplied = OneHundred.Times(Two);
    ...
    public void PositiveDecimal_DivideBy_Correctly_Divides() {
        PositiveDecimal divided = OneHundred.DivideBy(Two).Data.AsPositive().Data;
    ...
    public void PositiveDecimal_MinValue_DivideBy_MaxValue_Gives_Failed_Result() {
        PositiveDecimal min = PositiveDecimal.Create(0.0000000001M).Data;
        PositiveDecimal max = PositiveDecimal.Create(decimal.MaxValue).Data;
        Result<PositiveDecimal> divided = min.DivideBy(max).Data.AsPositive();
        Assert.True(divided.Failed);
    }

    [Fact]
    public void PositiveDecimal_Plus_Correctly_Adds() {
        Result<PositiveDecimal> added = OneHundred.Plus(Two);
    ...
    public void PositiveDecimal_Max_Value_Plus_Fails() {
        PositiveDecimal max = PositiveDecimal.Create(decimal.MaxValue).Data;
        Result<PositiveDecimal> added = max.Plus(max);
    ...
    public void PositiveDecimal_Max_Value_Times_Throws_Overflow() {
        PositiveDecimal max = PositiveDecimal.Create(decimal.MaxValue).Data;
        Result<PositiveDecimal> multiplied = max.Times(max);
        Assert.True(multiplied.Failed);
    }

    [Fact]
    public void NegativeDecimal_Times_Positive_Returns_NegativeDecimal() {
        NegativeDecimal negative = NegativeDecimal.Create(-1000).Data;
        PositiveDecimal positive = PositiveDecimal.Create(1000).Data;
        Result<NegativeDecimal> multiplied = negative.TimesPositive(positive);
        Assert.True(multiplied.Succeeded);
    ...
    public void NegativeDecimal_Times_NegativeDecimal_Returns_PositiveDecimal() {
        NegativeDecimal negativeOne = NegativeDecimal.Create(-1000).Data;
        NegativeDecimal negativeTwo = NegativeDecimal.Create(-1000).Data;
        Result<PositiveDecimal> multiplied = negativeOne.Times(negativeTwo);
        Assert.True(multiplied.Succeeded);
        Assert.Equal(1000000, multiplied.Data.Amount);
    }
    ...
    public void PositiveDecimal_Times_With_Max_Values_Returns_Failed_Result_Wrapping_OverflowException() {
        PositiveDecimal maxDecimal = PositiveDecimal.Create(decimal.MaxValue).Data;
        Result<PositiveDecimal> multipliedResult = maxDecimal.Times(maxDecimal);
    ...
    public void PositiveDecimal_DivideBy_Small_Value_By_Max_Value_Returns_Zero() {
        ...
        PositiveDecimal positiveSmall = PositiveDecimal.Create(small).Data;
        PositiveDecimal positiveMax = PositiveDecimal.Create(decimal.MaxValue).Data;
    ...
    public void PositiveDecimal_Plus_With_Max_Values_Returns_Failed_Wrapping_OverflowException() {
        PositiveDecimal maxPositive = PositiveDecimal.Create(decimal.MaxValue).Data;
        Result<PositiveDecimal> addedResult = maxPositive.Plus(maxPositive);
    ...
    public void AsNegative_Returns_NegativeDecimal_Success_Result() {
        INonPositiveDecimal negativeDecimal = NegativeDecimal.Create(-100).Data;
        Result<NegativeDecimal> asNegative = negativeDecimal.AsNegative();
    ...
    public void AsPositive_Returns_IPositiveDecimal_Success_Result() {
        ...
        Result<PositiveDecimal> asPositive = positiveDecimal.AsPositive();
